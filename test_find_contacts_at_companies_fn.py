...
class FindContactsTestCase(unittest.TestCase):
    ...
    def test_1(self):
        ...
        input_filename_companies = 'test_files/input_data_companies_test1.csv'
        input_filename_contacts = 'test_files/input_data_contacts_test1.csv' 
      
        (results_contacts, results_companies) = find_contacts_at_companies(
            input_filename_companies, input_filename_contacts
            )

        right_answer_file1 = 'test_files/output_companies_answer1.json'
        with open(right_answer_file1) as f_obj:
            right_companies_answer1 = json.load(f_obj)

        right_answer_file2 = 'test_files/output_contacts_answer1.json'
